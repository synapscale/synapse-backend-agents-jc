...
// Copiado de apps/ai-agents-sidebar/components/ui/button.tsx
var React = __importStar(require("react"));
var react_slot_1 = require("@radix-ui/react-slot");
var class_variance_authority_1 = require("class-variance-authority");
// Ajuste: importar cn localmente ou via utilitário compartilhado
var cn_1 = require("./cn");
...
var Button = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Comp, __assign({ className: (0, cn_1.cn)(buttonVariants({ variant: variant, size: size }), className), ref: ref }, props)));
});
