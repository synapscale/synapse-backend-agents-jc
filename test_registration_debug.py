...
def main():
    ...
    print(f"{'✅' if registration_success else '❌'} Registro de usuário: {'SIM' if registration_success else 'NÃO'}")
    print(f"{'✅' if login_success else '❌'} Login: {'SIM' if login_success else 'NÃO'}")
    print(f"{'✅' if user_info_success else '❌'} Informações do usuário: {'SIM' if user_info_success else 'NÃO'}")
    print(f"{'✅' if workspaces_success else '❌'} Workspaces: {'SIM' if workspaces_success else 'NÃO'}")
    
    if registration_success and login_success and user_info_success and workspaces_success:
