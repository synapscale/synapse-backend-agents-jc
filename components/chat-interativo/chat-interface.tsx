      ...
      <div className="flex-1 overflow-y-auto p-4 bg-gray-200">
        <div className="max-w-3xl mx-auto">
          <div className="flex mb-6">
            ...
            <div className="ml-2 flex flex-col justify-end space-y-2">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative">
            <input
              ...
              className="w-full border rounded-lg pl-4 pr-20 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
