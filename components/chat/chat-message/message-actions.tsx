...
export function MessageActions({ visible }: MessageActionsProps) {
  const { copied, liked, setLiked, copyToClipboard, regenerateResponse, focusMode } = useChatMessage()

  return (
    <div
      className={`flex items-center ${focusMode ? "justify-start" : "justify-end"} space-x-1 transition-opacity duration-200 ${
