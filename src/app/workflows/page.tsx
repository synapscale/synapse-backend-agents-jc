...
// Dados de exemplo para os workflows
const initialWorkflows: Workflow[] = [
  {
    id: "wf-001",
    name: "Agente NEUROHOOK-ULTRA",
    status: "inactive",
    visibility: "personal",
  ...
  },
  {
    ...
    created: "1 Mai",
    tags: [
      { id: "tag-001", name: "Agentes IA" },
      { id: "tag-002", name: "Hotmart" }
    ]
  },
  {
    id: "wf-003",
    name: "Banco De Dados| Recorrencia | Hotmart copy",
    status: "inactive",
    visibility: "personal",
    lastUpdated: "3 semanas atrás",
    created: "28 Jan",
    tags: [
      { id: "tag-002", name: "Hotmart" },
      { id: "tag-003", name: "Banco De Dados" }
    ]
  },
  {
    id: "wf-004",
    name: "Agente Vendedor Fluxo Respostas",
    status: "inactive",
    visibility: "personal",
    lastUpdated: "3 semanas atrás",
    created: "1 Mai",
  ...
  {
    id: "wf-006",
    name: "Agente SDR 2 Follow Up Leads",
    status: "inactive",
    visibility: "personal",
    lastUpdated: "3 semanas atrás",
    created: "1 Mai",
...
export default function WorkflowsPage() {
  ...
  const filteredWorkflows = workflows.filter(workflow => {
    return workflow.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
           workflow.tags.some(tag => tag.name.toLowerCase().includes(searchQuery.toLowerCase()))
  })
  ...
  // Alternar o status de um workflow
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem onClick={() => deleteWorkflow(workflow.id)} className="text-red-600">
                                    Excluir
                                  </DropdownMenuItem>
                                </DropdownMenuContent>
                              </DropdownMenu>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreateWorkflow}>Criar</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
