...
class FileBase(BaseModel):
    ...
    category: str = Field(
        ...,
        description="Categoria do arquivo (image, video, audio, document, archive)",
    )
...
class FileUpdate(BaseModel):
    ...
    tags: list[str] | None = Field(None, description="Tags para categorização")
    description: str | None = Field(None, description="Descrição do arquivo")
    is_public: bool | None = Field(None, description="Se o arquivo é público")
...
class FileInDB(FileBase):
    ...
    tenant_id: str = Field(..., description="ID do tenant - multi-tenancy")
    ...
    @validator("id", "user_id", "tenant_id", pre=True)
...
class FileResponse(BaseModel):
    ...
    id: str
    user_id: str  # Adicionando campo que estava faltando
    tenant_id: str  # CRÍTICO: campo de multi-tenancy adicionado
    filename: str
    original_filename: str
    content_type: str
    file_size: int
