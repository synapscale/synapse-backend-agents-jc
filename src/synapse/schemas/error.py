...
class ErrorDetail(BaseModel):
    ...
    """
    field: Optional[str] = Field(None, description="Campo específico relacionado ao erro")
    ...
    context: Optional[Dict[str, Any]] = Field(None, description="Contexto adicional do erro")
...
class ErrorResponse(BaseModel):
    ...
    """
    error: Dict[str, Any] = Field(..., description="Objeto contendo informações do erro")
...
class DatabaseErrorResponse(BaseModel):
    ...
    """
    error: Dict[str, Any] = Field(..., description="Informações do erro de banco de dados")
