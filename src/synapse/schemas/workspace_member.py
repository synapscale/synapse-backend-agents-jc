...
class WorkspaceMemberBase(BaseModel):
    ...
    custom_permissions: Optional[dict] = Field(None, description="Permissões customizadas")
    notification_preferences: Optional[dict] = Field(None, description="Preferências de notificação")
...
class WorkspaceMemberUpdate(BaseModel):
    ...
    custom_permissions: Optional[dict] = Field(None, description="Novas permissões customizadas")
    notification_preferences: Optional[dict] = Field(None, description="Novas preferências de notificação")
