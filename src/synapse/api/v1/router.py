...
# Autenticação - Base fundamental (router já tem prefix="/auth")
...
api_router.include_router(
    ...
    tags=["user-variables"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Variable not found"}}
)
...
api_router.include_router(
    ...
    prefix="/workflows", 
    tags=["workflows"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Workflow not found"}}
)
...
api_router.include_router(
    ...
    prefix="/executions", 
    tags=["executions"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Execution not found"}}
)
...
api_router.include_router(
    ...
    prefix="/templates", 
    tags=["templates"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Template not found"}}
)
...
api_router.include_router(
    ...
    prefix="/nodes", 
    tags=["nodes"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Node not found"}}
)
...
api_router.include_router(
    ...
    prefix="/agents", 
    tags=["agents"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Agent not found"}}
)
...
api_router.include_router(
    ...
    tags=["conversations"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Conversation not found"}}
)
...
api_router.include_router(
    ...
    prefix="/files", 
    tags=["files"],
    responses={401: {"description": "Unauthorized"}, 413: {"description": "File too large"}}
)
...
api_router.include_router(
    websockets_router, 
    tags=["websockets"],
    responses={401: {"description": "Unauthorized"}, 4001: {"description": "Invalid token"}}
)
...
api_router.include_router(
    ...
    prefix="/marketplace", 
    tags=["marketplace"],
    responses={401: {"description": "Unauthorized"}, 404: {"description": "Component not found"}}
)
...
api_router.include_router(
    ...
    prefix="/workspaces", 
    tags=["workspaces"],
    responses={401: {"description": "Unauthorized"}, 403: {"description": "Access denied"}}
)
