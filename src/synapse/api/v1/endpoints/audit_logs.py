"""
Endpoints for managing AuditLogs.
"""
...
from synapse.schemas.audit_log import (
    AuditLogCreate,
    AuditLogUpdate,
    AuditLogResponse,
    AuditLogList,
)
from synapse.models import AuditLog, User
...
async def get_audit_log(
    ...
    result = await db.execute(
        select(AuditLog).where(AuditLog.id == item_id, AuditLog.tenant_id == current_user.tenant_id)
    )
...
async def list_audit_logs(
    ...
    """List all audit logs for the current user."""
