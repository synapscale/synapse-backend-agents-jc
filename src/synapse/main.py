...
async def root():
    ...
    """
    return {'message': '🚀 SynapScale Backend API', 'version': '1.0.0', 'status': 'running', 'documentation': {'swagger': '/docs', 'redoc': '/redoc'}, 'endpoints': {'health': '/health', 'api': '/api/v1'}, 'features': ['Autenticação JWT', 'Workflows de Automação', 'Agentes AI', 'Gerenciamento de Arquivos', 'Histórico de Conversas']}
