...
class LocalStorageProvider:
    ...
    async def generate_download_url(self, category: str, stored_name: str) -> str:
        ...
        file_path = self.base_path / category / stored_name
        if not file_path.exists():
            logger.warning(f"Tentativa de gerar URL para arquivo inexistente: {file_path}")
...
class StorageManager:
    ...
    def __init__(self):
        ...
        logger.info(f"Gerenciador de armazenamento inicializado com provedor: {settings.storage_provider}")
