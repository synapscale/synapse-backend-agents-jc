...
class TransformExecutor(BaseExecutor):
    ...
    async def _execute_transformation(
        ...
        try:
            if transform_type == TransformType.MAP:
                ...
                raise ValueError(f"Tipo de transformação não suportado: {transform_type}")
    ...
    def _transform_map(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Any:
        """
    ...
    def _transform_filter(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Any:
        """
    ...
    def _transform_extract(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Any:
        """
    ...
    def _transform_convert(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Any:
        """
    ...
    def _transform_validate(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Dict[str, Any]:
        """
    ...
    def _transform_sort(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Any:
        """
        ...
        if sort_key:
            ...
            return sorted(data, key=lambda x: self._extract_value(x, sort_key), reverse=reverse)
        else:
            # Ordena diretamente
            return sorted(data, reverse=reverse)
    
    def _transform_group(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Dict[str, List]:
        """
    ...
    def _transform_aggregate(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Dict[str, Any]:
        """
    ...
    def _transform_custom(self, data: Any, config: Dict[str, Any], context: ExecutionContext) -> Any:
        """
    ...
    def _evaluate_expression(self, expression: str, data: Any, context: ExecutionContext) -> Any:
        ...
        resolved_expr = self.resolve_template_variables(expression, context, {"item": data})
    ...
    def _evaluate_condition(self, condition: Dict[str, Any], data: Any, context: ExecutionContext) -> bool:
        """
        ...
        if operator == "eq":
            ...
            return value in field_value if hasattr(field_value, "__contains__") else False
        elif operator == "regex":
    ...
    def _validate_rule(self, data: Any, rule: Dict[str, Any], context: ExecutionContext) -> Dict[str, Any]:
        """
