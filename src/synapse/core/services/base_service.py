...
class BaseService(Generic[TModel, TCreate, TUpdate]):
    ...
    def __init__(self, repository: IRepository = None, model_class: Type[TModel] = None, 
                 create_schema: Type[TCreate] = None, update_schema: Type[TUpdate] = None):
        """
    ...
    async def list(
        ...
        try:
            ...
            self._log_operation("LIST", f"skip={skip}, limit={limit}, filters={filters}")
    ...
    async def create(self, obj_in: Union[TCreate, Dict[str, Any]]) -> TModel:
        ...
        try:
            ...
            self._log_operation("CREATE_SUCCESS", f"id={getattr(result, 'id', 'unknown')}")
    ...
    async def update(self, id: Any, obj_in: Union[TUpdate, Dict[str, Any]]) -> Optional[TModel]:
        """
        Update entity.
