...
export default function WorkflowsPage() {
  ...
  // Carregar workflows do localStorage ao iniciar
  useEffect(() => {
  ...
  const handleCreateWorkflow = () => {
    ...
    // Não criar o workflow ainda, apenas armazenar o nome temporariamente
    // e redirecionar para o Canvas
    const tempId = `temp-${Date.now()}`
    localStorage.setItem('temp_workflow_name', newWorkflowName)
    
    setIsCreateDialogOpen(false)
    setNewWorkflowName("")
    
    // Redirecionar para o Canvas de criação
    window.location.href = `/canvas?new=true&temp_id=${tempId}`
  }
