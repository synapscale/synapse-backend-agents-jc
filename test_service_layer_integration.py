...
async def test_service_layer_integration():
    ...
    try:
        ...
        try:
            ...
            # Create user
            from synapse.services.sample_test_service import UserCreateRequest, UserUpdateRequest
            ...
            try:
                ...
                rollback_user = await test_service.user_repository.find_by_email(rollback_data.email)
                assert rollback_user is None, "Rollback user should not exist in database"
            ...
            assert test_service_2 is not test_service, "Should get different instances (scoped)"
            ...
            # Test find by email
            found_user = await test_service.user_repository.find_by_email(created_user.email)
            ...
            logger.info(f"✅ Custom repository method count_users works: {user_count} users")
