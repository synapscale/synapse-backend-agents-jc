...
def upgrade() -> None:
    ...
    # addresses table will be dropped later after customers table (dependency issue)
    ...
    # users table will be dropped at the very end (many dependencies)
    ...
    # workflows table will be dropped later (dependencies with users/workspaces)
    ...
    # nodes table will be dropped later (dependencies with users/workspaces)
    ...
    # Now safe to drop addresses table after customers table is dropped
    ...
    # workspaces table will be dropped later (dependencies with users)
    ...
    # Now safe to drop synapscale_db tables in correct dependency order
    # workflow_nodes is already dropped (line 290) - correct position ✓
