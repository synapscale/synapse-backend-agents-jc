...
def upgrade():
    ...
    if "tags" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "target_type", sa.String(50), nullable=False
            ...
            sa.Column(
                "is_system_tag", sa.Boolean(), server_default="false"
            ...
            sa.ForeignKeyConstraint(
                ["created_by_user_id"], ["synapscale_db.users.id"], ondelete="SET NULL"
            ),
            sa.PrimaryKeyConstraint("id"),
            schema="synapscale_db",
        )
        op.create_index(
            "ix_tags_target_type", "tags", ["target_type"], schema="synapscale_db"
        )
        op.create_index(
            "ix_tags_target_id", "tags", ["target_id"], schema="synapscale_db"
        )
        op.create_index(
            "ix_tags_tag_name", "tags", ["tag_name"], schema="synapscale_db"
        )
        op.create_index(
            "ix_tags_tag_category", "tags", ["tag_category"], schema="synapscale_db"
        )
        op.create_index(
            "ix_tags_is_system_tag", "tags", ["is_system_tag"], schema="synapscale_db"
        )
        op.create_index(
            "ix_tags_created_by_user_id",
            "tags",
            ["created_by_user_id"],
            schema="synapscale_db",
        )
