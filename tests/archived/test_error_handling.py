...
class TestCustomExceptions:
    ...
    def test_synapse_base_exception_with_code_and_details(self):
        ...
        exc = SynapseBaseException(
            "Erro de validação", error_code="VALIDATION_001", details=details
        )
...
class TestErrorHandlers:
    ...
    async def test_value_error_handler(self, mock_request):
        ...
        assert (
            error_data["message"] == "Valor inválido fornecido"
        ...
        try:
            ...
            if response.status_code == 500:
                ...
                mock_request.url.__str__ = MagicMock(
                    return_value="http://test/test/generic-error"
                )
        ...
        test_cases = [
            ...
            (
                ...
                RequestValidationError(
                    [{"loc": ("test",), "msg": "test", "type": "value_error"}]
                ),
            ),
