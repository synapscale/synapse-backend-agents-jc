...
def validate_environment():
    ...
    try:
        ...
        try:
            ...
            print(
                "      Execute 'python main.py' ou 'uvicorn main:app --reload' primeiro"
            )
...
def main():
    ...
    print(
        "2. Para salvar relatório JSON: python test_endpoints_unified_improved.py --output-json"
    )
    print(
        "3. Para usar URL diferente: python test_endpoints_unified_improved.py --base-url http://sua-url"
    )
