...
async def test_structured_logging():
    ...
    logger.logger.warning(
        "Teste de log WARNING",
        extra={"error_type": "ValidationError", "url": "/api/v1/test"},
    )
    ...
    try:
        ...
        logger.logger.error(
            ...
            extra={"error_type": type(e).__name__, "test_context": "error_logging"},
        )
...
async def test_error_tracking():
    ...
    for i in range(3):
        try:
            ...
            logger.logger.error(
                f"Database error: {e}", extra={"error_type": "DatabaseError"}
            )
    ...
    for i in range(2):
        try:
            ...
            logger.logger.error(
                f"Validation error: {e}", extra={"error_type": "ValidationError"}
            )
