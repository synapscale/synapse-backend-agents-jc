...
def test_service_layer_imports():
    ...
    try:
        ...
        from synapse.core.services import (
            BaseService as ImportedBaseService,
            get_container,
            configure_services as config_services,
        )
        ...
        for method in expected_methods:
            assert hasattr(
                BaseService, method
            ), f"BaseService should have {method} method"
        ...
        for method in expected_repo_methods:
            assert hasattr(
                IRepository, method
            ), f"IRepository should have {method} method"
        ...
        for method in expected_container_methods:
            assert hasattr(
                ServiceContainer, method
            ), f"ServiceContainer should have {method} method"
