...
def test_final_render_setup():
    ...
    cmd = [
        ...
        "0.0.0.0",
        "--port",
        "8001",  # Usar porta diferente para evitar conflito
        "--workers",
        "1",
    ]
    ...
    try:
        ...
        if process.poll() is None:
            ...
            if (
                "connection to server" in stderr
                or "could not translate host name" in stderr
            ) and "Application startup complete" in stderr:
