...
async def create_template(
    ...
    try:
        ...
        logger.error(f"Erro ao criar template: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def search_templates(
    ...
    try:
        ...
        logger.error(f"Erro ao buscar templates: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_template(
    ...
    try:
        ...
        logger.error(f"Erro ao obter template: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def update_template(
    ...
    try:
        ...
        logger.error(f"Erro ao atualizar template: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def delete_template(
    ...
    try:
        ...
        logger.error(f"Erro ao deletar template: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def publish_template(
    ...
    try:
        ...
        logger.error(f"Erro ao publicar template: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def download_template(
    ...
    try:
        ...
        logger.error(f"Erro ao realizar download: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def install_template(
    ...
    try:
        ...
        logger.error(f"Erro ao instalar template: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def add_favorite(
    ...
    try:
        ...
        logger.error(f"Erro ao adicionar favorito: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_my_favorites(
    ...
    try:
        ...
        logger.error(f"Erro ao obter favoritos: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def create_review(
    ...
    try:
        ...
        logger.error(f"Erro ao criar review: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_template_reviews(
    ...
    try:
        ...
        logger.error(f"Erro ao obter reviews: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def create_collection(
    ...
    try:
        ...
        logger.error(f"Erro ao criar coleção: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def list_collections(
    ...
    try:
        ...
        logger.error(f"Erro ao listar coleções: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_template_stats(
    ...
    try:
        ...
        logger.error(f"Erro ao obter estatísticas: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_marketplace_stats(
    ...
    try:
        ...
        logger.error(f"Erro ao obter estatísticas do marketplace: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_my_template_stats(
    ...
    try:
        ...
        logger.error(f"Erro ao obter estatísticas do usuário: {str(e)}", extra={"error_type": type(e).__name__})
        raise
