...
async def create_tag(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em create_tag: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
def list_tags(
    ...
    try:
        ...
        try:
            ...
            query = select(Tag).filter(Tag.tenant_id == current_user.tenant_id)
            if target_type:
        ...
        logger.error(f"Erro inesperado em list_tags: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def add_tag_to_conversation(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em add_tag_to_conversation: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
def list_tags_for_conversation(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em list_tags_for_conversation: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
def add_tag_to_message(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em add_tag_to_message: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
def list_tags_for_message(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em list_tags_for_message: {str(e)}", extra={"error_type": type(e).__name__})
        raise
