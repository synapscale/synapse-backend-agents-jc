...
async def create_component(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em create_component: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def search_components(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em search_components: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_component(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_component: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def update_component(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em update_component: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def delete_component(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em delete_component: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def download_component(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em download_component: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def create_rating(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em create_rating: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_ratings(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_ratings: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_rating_stats(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_rating_stats: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def purchase_component(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em purchase_component: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_my_purchases(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_my_purchases: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_purchase(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_purchase: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_component_metadata(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_component_metadata: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_marketplace_stats(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_marketplace_stats: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_categories(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_categories: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_popular_tags(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_popular_tags: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_recommendations(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_recommendations: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_similar(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_similar: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_pending_moderation(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_pending_moderation: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def moderate_component(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em moderate_component: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def bulk_operations(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em bulk_operations: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_revenue_report(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_revenue_report: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_downloads_report(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_downloads_report: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_top_components_report(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_top_components_report: {str(e)}", extra={"error_type": type(e).__name__})
        raise
