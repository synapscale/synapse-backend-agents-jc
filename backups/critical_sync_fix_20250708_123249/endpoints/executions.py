...
async def list_executions(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em list_executions: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def create_execution(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em create_execution: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_execution(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_execution: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def update_execution_status(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em update_execution_status: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def cancel_execution(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em cancel_execution: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_execution_logs(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_execution_logs: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_execution_metrics(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_execution_metrics: {str(e)}", extra={"error_type": type(e).__name__})
        raise
...
async def get_execution_nodes(
    ...
    try:
        ...
        logger.error(f"Erro inesperado em get_execution_nodes: {str(e)}", extra={"error_type": type(e).__name__})
        raise
